...
namespace Sabresaurus.UnityPrefsEditor
{
    public class UnityPrefsEditor : EditorWindow
    {
        ...
        private static readonly GUIContent deletePrefContent = new GUIContent("x", "Delete Pref");
        ...
        [MenuItem("Tools/Dangobums/Unity Prefs Editor")]
        ...
        private void DrawMainList()
        {
            ...
            for (int i = firstShownIndex; i < shownIndexLimit; i++)
            {
                ...
                // Delete button
                if (GUI.Button(rightRect, deletePrefContent))
                {
